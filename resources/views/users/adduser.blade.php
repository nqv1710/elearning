            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <!-- /.card-header -->
                        @if ($errors->any())
                            <div class="alert alert-danger" style="font-size: 20px;color: red;text-align: center">Dữ
                                liệu nhập vào không hợp lệ</div>
                        @else
                    ...
                    <option value="" {{old('role')==$role->id?'selected':false}}>{{$role->name}}</option>
                    @endforeach --}}
                                    </select>
                                    @error('role')
                                        <span style="color:red">{{ $message }}</span>
