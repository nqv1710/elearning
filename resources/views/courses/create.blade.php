...
<div class="container-fluid">
    ...
    <div class="col-12 py-3">
        <a class="btn btn-primary" href="">Khóa học</a>
        <a class="btn btn-outline-info" href="">Danh mục</a>
    </div>
                        ...
                        <div class="image-courses">
                            ...
                            <div class="file-upload">
                                <div class="image-upload-wrap">
                                    <input class="file-upload-input" name="image" type='file' value=""
                    ...
                    <div class="col-12 col-sm-8">
                        ...
                        <div class="row mb-3">
                            <div class="col-12 col-sm-12 text-start text-sm-start">
                                <input class="w-50 form-control" type="text" name="name">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 col-sm-4 text-start text-sm-start">
                        ...
                        <div class="row mb-3">
                            <div class="col-12 col-sm-12 text-start text-sm-start">
                                <textarea class="w-50 form-control" name="description" id="" cols="30" rows="8"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 d-sm-flex justify-content-sm-center d-grid mx-auto">
                        <div class="btn-fixed">
                            ...
                            <a href="{{ route('courses.index') }}" class="btn btn-warning"
